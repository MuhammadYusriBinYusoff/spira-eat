...
export const mealReducer = (state, action) => {
    switch(action.type){
        case FETCH_CATEGORY_BEGIN:
            return {
                ...state,
                categoryLoading: true  //this is state we got from initialState at mealCOntext.js
            }
        case FETCH_CATEGORY_SUCCESS:
            return {
                ...state, //asign all cateogries, categoriesmeal, meal ,.....
                categoryLoading: false,
                categories: action.payload  //assign current data to categories
            }
